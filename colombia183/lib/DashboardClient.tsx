...
export default function DashboardClient({
  ...
  const { daysLast365, windowStart, windowEnd, worstDays, worstWindowStart, worstWindowEnd } = computeRolling(trips);
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "24px 16px 80px" }}>
        ...
        <div style={{ background: "#16192a", borderRadius: 16, padding: "24px", marginBottom: 16, border: "1px solid #2a2d3e", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ fontSize: 11, fontWeight: 700, color: "#4b5563", letterSpacing: "0.08em", marginBottom: 16 }}>
            LAST 365 DAYS · {formatDate(toISO(windowStart))} → {formatDate(toISO(windowEnd))}
          </div>
          ...
          <div style={{ display: "flex", gap: 28, alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 180, paddingTop: 4 }}>
              ...
              <div style={{ fontSize: 12, color: "#6b7280", background: "#0f1117", borderRadius: 8, padding: "8px 12px", lineHeight: 1.6 }}>
                This resets daily — yesterday's days drop off as new ones are added.
              </div>
            </div>
          </div>
        ...
        {/* Worst historical window warning (only show if different and concerning) */}
        {showWorstWarning && worstWindowStart && worstWindowEnd && (
          <div style={{ background: "#16192a", borderRadius: 12, padding: "14px 16px", marginBottom: 16, border: "1px solid #dd6b2033" }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: "#dd6b20", marginBottom: 4 }}>⚠️ Historical Peak Window</div>
            <div style={{ fontSize: 13, color: "#9ca3af" }}>
              Your highest ever 365-day count was <strong style={{ color: "#FCD116" }}>{worstDays} days</strong> in the window{" "}
